package com.cxfly.test.bigdata.hbase;
...
public class HbaseTest {
	...
	static {
		...
		conf.set("hbase.zookeeper.quorum", "server007,arch,ubuntu");
	}
	...
	public static void getResultByColumn(String tableName, String rowKey,
		...
		for (Cell cell : listCells) {
			...
			System.out
			.println("qualifier:" + Bytes.toString(cell.getQualifierArray(),cell.getQualifierOffset(), cell.getQualifierLength()));
