...
public class SkuDefs implements Serializable {
    ...
    private final List<SkuDef> skuDefList       = new ArrayList<SkuDef>();
    ...
    public boolean equals(Object obj) {
        ...
        if (skuDefList == null) {
            if (other.skuDefList != null)
                return false;
        } else {
            if (other.skuDefList == null)
                return false;
            if (skuDefList.size() != other.skuDefList.size())
                return false;
            if (!skuDefList.containsAll(other.skuDefList))
                return false;
        }
        return true;
    }
