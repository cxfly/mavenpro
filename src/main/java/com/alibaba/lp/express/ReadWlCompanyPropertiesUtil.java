...
public class ReadWlCompanyPropertiesUtil {
    ...
    static {
        try {
            InputStream fileInputStream = ReadWlCompanyPropertiesUtil.class.getClassLoader().getResourceAsStream("express/logistics_company.properties");
            properties.load(fileInputStream);
            fileInputStream.close();

            InputStream logisticsInfofis = ReadWlCompanyPropertiesUtil.class.getClassLoader().getResourceAsStream("express/logistics_company_info.properties");
            logisticsInfoProperties.load(logisticsInfofis);
            logisticsInfofis.close();

            InputStream matchfis = ReadWlCompanyPropertiesUtil.class.getClassLoader().getResourceAsStream("express/province_match.properties");
