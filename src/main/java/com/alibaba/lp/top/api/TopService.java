package com.alibaba.lp.top.api;
...
import com.alibaba.lp.top.KeyNamePair;
import com.alibaba.lp.top.SkuUtil;
import com.alibaba.lp.top.TaoBaoFullItemInfo;
import com.alibaba.lp.top.TaoBaoSkuExtend;
...
public class TopService {
    ...
    public TaoBaoFullItemInfo getSkuList(long itemId) {
        ...
        Map<String, String> custSkuPropMap = SkuUtil.parsePropertyAlias2Map(item.getPropertyAlias());
        Map<String, KeyNamePair<String, String>> propsNameMap = SkuUtil.parsePropsName2Map(item.getPropsName());
        ...
        for (Sku sku : skus) {
            ...
            taoBaoSkuExtend.setPropertiesValue(SkuUtil.joinKeyNamePair2Str(propKeyPairList, PROPERTYS_SPLITER));
            taoBaoSkuExtend.setCustomPropertiesValue(SkuUtil.joinKeyNamePair2Str(custPropKeyPairList, PROPERTYS_SPLITER));
            taoBaoSkuExtend.setPropertiesWithCustomProperties(SkuUtil.joinKeyNamePair2Str(propWithCustPropKeyPairList,
                                                                                          PROPERTYS_SPLITER));
        ...
        if (!CollectionUtils.isEmpty(propsNameCache)) {
            ...
            taoBaoFullItemInfo.setProductSkuDefinition(SkuUtil.joinSkuKeyGroupMap2Str(skuKeyGroupMap));
        }
