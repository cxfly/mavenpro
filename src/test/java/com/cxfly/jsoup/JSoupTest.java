...
public class JSoupTest {
	...
	public void testRestoreContent() throws Exception {
		Document parse = Jsoup.parse(new File(
				"F:/Project/MyProject/mavenpro/src/test/java/com/cxfly/jsoup/NewFile2.html"), "UTF-8");
	...
	public void testBuildContent() throws Exception {
		Document parse = Jsoup.parse(new File(
				"F:/Project/MyProject/mavenpro/src/test/java/com/cxfly/jsoup/NewFile.html"), "UTF-8");
		parse.outputSettings().prettyPrint(false);
		Element body = parse.body();
		System.out.println(body);
		System.out.println("=======================================");
